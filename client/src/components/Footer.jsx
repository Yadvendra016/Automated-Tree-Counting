...
<<<<<<< HEAD
  return (
    <div className="flex flex-row justify-between justify-items-center items-center bottom-0 bg-gray-200 left-0 w-full text-black px-24 pt-4 pb-2">
      <div>
        <a
          href="https://github.com/Yadvendra016/Automated-Tree-Counting"
          className="flex flex-row no-underline gap-3 text-black hover:underline"
        >
          <img
    ...
    <div  className="flex flex-row justify-between justify-items-center items-center fixed bottom-0 bg-gray-200 left-0 w-full text-black px-24 pt-4 pb-2">
      ...
      <div>
        <a href="https://github.com/Yadvendra016/Automated-Tree-Counting" className="flex flex-row no-underline gap-3 text-black hover:underline">
            ...
            <p>View Source Code</p>
>>>>>>> 8cfbba8f42c0245508b6854fd700a5c505cca5de
        </a>
      </div>
